...
export class ArtistEventsService {
     ...
     * @param date Can be one of the following values: \&quot;upcoming\&quot;, \&quot;past\&quot;, \&quot;all\&quot;, or a date range e.g. \&quot;2015-05-05,2017-05-05\&quot;. If not specified, only upcoming shows are returned
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public artistEvents(artistname: string, appId: string, date?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<EventData>>;
    public artistEvents(artistname: string, appId: string, date?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<EventData>>>;
    public artistEvents(artistname: string, appId: string, date?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<EventData>>>;
    public artistEvents(artistname: string, appId: string, date?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (artistname === null || artistname === undefined) {
            throw new Error('Required parameter artistname was null or undefined when calling artistEvents.');
        }

        if (appId === null || appId === undefined) {
            throw new Error('Required parameter appId was null or undefined when calling artistEvents.');
        }
        ...
        return this.httpClient.get<Array<EventData>>(`${this.basePath}/artists/${encodeURIComponent(String(artistname))}/events`,
            {
